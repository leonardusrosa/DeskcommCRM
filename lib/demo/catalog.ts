...
export const DENTAL_DEMO_CATALOG: DentalDemoCatalogCard[] = [
  {
    ...
    included: ["Inbox WhatsApp de demostración", "Embudo dental", "Agenda multi-profesional", "Servicios odontológicos"],
  },
  {
    country: "MX",
    countryName: "México",
  ...
  },
  {
    ...
    included: ["Inbox WhatsApp de demostración", "Embudo dental", "Agenda nativa", "Seguimiento comercial"],
  },
  {
    country: "PT",
    ...
    included: ["Inbox WhatsApp de demonstração", "Funil dentário", "Agenda multi-profissional", "Serviços dentários"],
  },
];
